...
function kopa_head() {
     ...
     * Custom Background
      ================================================================================ */
    $kopa_theme_options_layout = get_option('kopa_theme_options_layout', 'wide');
    $kopa_theme_options_background_image = get_option('kopa_theme_options_background_image');
    $kopa_theme_options_background_color_code = get_option('kopa_theme_options_background_color_code');
    $kopa_theme_options_background_repeat = get_option('kopa_theme_options_background_repeat');

    if ( $kopa_theme_options_layout === 'box' ) {
        echo "<style>
            body.kopa-boxed {
                background-image: url($kopa_theme_options_background_image);
                background-color: $kopa_theme_options_background_color_code;
                background-repeat: $kopa_theme_options_background_repeat;
            }
        </style>";
    }
