...
?>
        ...
        <footer id="page-footer">
            <div class="wrapper">
                <div class="row-fluid">
                    <div class="span12">
                        <p id="copyright"><?php echo strip_tags( stripslashes( get_option( 'kopa_theme_options_copyright', __('Copyrights. &copy; 2013 by KOPASOFT', kopa_get_domain()) ) ) ); ?></p>
                        <?php 
                        if ( has_nav_menu('bottom-nav') ) {
                            wp_nav_menu( array(
                                ...
                                'depth'          => -1 //  displays links at any depth and arranges them in a single, flat list.
                            ) );
                        }
                        ?>
                    </div><!--span12-->
